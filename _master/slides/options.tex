...
\usetheme{Karimnlp} % Antibes Boadilla Warsaw Karim
...
\titlegraphic{%
	...
	\hspace{2cm}%
	\includegraphics[height=1.5cm]{../../extra/logo/esi.nlp-logo.png}%
}
