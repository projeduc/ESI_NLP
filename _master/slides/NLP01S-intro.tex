...
\begin{exampleblock}{Example of different meanings}
	The word \expword{chicken} has many meanings (from \url{http://wordnetweb.princeton.edu/perl/webwn})
	\begin{itemize}
...
\begin{itemize}
	...
	\item \keyword{Trope} (figurative language): metaphors (\expword{``It's raining cats and dogs"}), metonomy (\expword{``The room applauded" [the people in the room]}), irony (\expword{``What a beautiful day!" [to mean that it's raining cats and dogs.]}).
