...
\begin{frame}
	...
	\begin{itemize}
		\item Course slogan
		\begin{itemize}
			\item \keyword{Language is just an interface; communication is the key}
...
\begin{enumerate}
	...
	\item {\color{red}Transformers (exceptionally)}
	\item ML for NLP
...
\begin{frame}
	...
	\begin{itemize}
		...
		\item \optword{Languages:} Python (previously, Java and Javascript/nodejs as well).
