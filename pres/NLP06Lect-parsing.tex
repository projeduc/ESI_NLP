...
\begin{frame}
	...
	\begin{itemize}
		\item ``Oracle'' model learns to predict the transition $\hat{t}$ given:
		\begin{itemize}
		...
		\item To train the ``Oracle'' model, the parsing algorithm is used to generate gold transition sequences
...
\begin{frame}
	...
	\begin{itemize}
		\item $\Psi$ is a scoring function, $ \mathcal{T}(G) $ is the set of all valid dependency trees over $G$
